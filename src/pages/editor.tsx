...
const ModelGrid: FC<ModelGridProps> = ({ data, isLoading }) => {
  ...
  return (
    <div
      className={"grid w-full p-4 pb-20 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4"}
    >
      {isLoading && (
        ...
        return (
          ...
          >
            <div className="relative group">
              <img role="button" src={model.thumbnail} alt={model.name} className="w-full h-40 rounded-none" />
